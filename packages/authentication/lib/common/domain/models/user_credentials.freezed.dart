...
abstract class $UserCredentialsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String uid, String email, String name, String photo});
}
...
class _$_UserCredentials implements _UserCredentials {
  ...
  @override
  String toString() {
    return 'UserCredentials(uid: $uid, email: $email, name: $name, photo: $photo)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, uid, email, name, photo);
...
abstract class _UserCredentials implements UserCredentials {
  const factory _UserCredentials(
      ...
      required final String photo}) = _$_UserCredentials;
